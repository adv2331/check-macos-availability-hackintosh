# Hardware Compatibility Database for Hackintosh / OpenCore
# Sources: Dortania OpenCore Install Guide, community lists
...
SUPPORTED_CPU_FAMILIES = {
    "intel": {
        ...
        "notes": {
            "i3-12":"12th gen: E-core disabling via ACPI patches required.",
            "i5-12":"12th gen: E-core disabling via ACPI patches required.",
            "i7-12":"12th gen: E-core disabling via ACPI patches required.",
            "i9-12":"12th gen: E-core disabling via ACPI patches required.",
            "i3-13":"13th gen: E-core disabling via ACPI patches required.",
            "i5-13":"13th gen: E-core disabling via ACPI patches required.",
            "i7-13":"13th gen: E-core disabling via ACPI patches required.",
            "i9-13":"13th gen: E-core disabling via ACPI patches required.",
        },
    },
    "amd": {
        "supported": [
        ...
        "notes": {
            "amd_general":"AMD needs a patched XNU kernel. DRM and virtualisation may misbehave.",
...
SUPPORTED_GPUS = {
    "nvidia": {
        ...
        "notes": {
            "gtx 750":"Maxwell: requires web drivers, capped at macOS High Sierra 10.13.",
            "gtx 950":"Maxwell: requires web drivers, capped at macOS High Sierra 10.13.",
            "gtx 960":"Maxwell: requires web drivers, capped at macOS High Sierra 10.13.",
            "gtx 970":"Maxwell: requires web drivers, capped at macOS High Sierra 10.13.",
            "gtx 980":"Maxwell: requires web drivers, capped at macOS High Sierra 10.13.",
    ...
    "amd": {
        ...
        "notes": {
            "rx 6400":"No HW video encode/decode; PCIe x4 bandwidth issues.",
            "rx 7600":"RDNA 3 support is maturing; some features may be absent.",
            "rx 7700":"RDNA 3 support is maturing; some features may be absent.",
            "rx 7800":"RDNA 3 support is maturing; some features may be absent.",
            "rx 7900":"RDNA 3 support is maturing; some features may be absent.",
        },
    },
    "intel": {
        "supported": [
        ...
        "notes": {
            "iris xe":"Iris Xe (12th gen+) has limited, experimental support.",
...
SUPPORTED_WIFI = {
    ...
    "notes": {
        "intel":    "Intel Wi-Fi works via itlwm kext; AirDrop/Handoff may be limited.",
        "broadcom": "Broadcom: full native AirDrop, Handoff, and Sidecar support.",
        "realtek":  "Realtek Wi-Fi has no macOS driver; replacement required.",
    },
}
...
GOOD_CHIPSETS = [
    ...
    "x299","x399","x570","b550","a520",
    "x470","b450","x370","b350","a320",
]
UNSUPPORTED_CHIPSETS = ["z890","b860","h870","w890"]
KNOWN_BOARD_VENDORS  = ["asus","gigabyte","msi","asrock","biostar","supermicro"]
